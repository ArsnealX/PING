...
class DemoCode: NSObject {
    class func MainViewControllerDemoCode(cell:tasksTableViewCell?, indexPath:NSIndexPath) {
        if indexPath.row == 0 {
            cell?.topLeftImgView.image = UIImage(named: "testAvatar_1")
            ...
            cell?.topLeftImgView.image = UIImage(named: "testAvatar_2")
            ...
            cell?.topLeftImgView.image = UIImage(named: "testAvatar_5")
            ...
            cell?.topLeftImgView.image = UIImage(named: "testAvatar_9")
