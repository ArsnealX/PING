...
extension UIViewController {
    ...
    func addRifhtButtonWithIcon(image:UIImage?,actionClick:Selector?) ->Void{
        self.addRightButtonWithMessage(image, title: nil, actionClick: actionClick)
    }

    
    func addRightButtonWithMessage(image:UIImage?,
                                  title:String?,
                                  actionClick:Selector?) -> Void {
